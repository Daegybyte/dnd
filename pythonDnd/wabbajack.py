...
5 == Polymorph
    ...
    9 == Bees!
6 == Invisibility
    0/1 you/your target is now invisible
7 == Summon Kobold Minion
8 == Knocked Prone
9 == a random potion appears in your pocket
10 == ???????????????
11 == Fear 1/10
12 == You take one level of exhaustion
13 == Ballbearings
14 == Absorb Health
15 == ????????????
16 == Chance for Buff
    1..5 1 buffs enemy
    1. Haste 2. Freedom of movement 3. Invisibility 4. 0/1enlarge/reduce
17 == Replace target with random amount of cheese**
18 == Unspecified Damage
    0/1 you/your target take 1..10 damage
19 == Causes explosion
    "Everyone in range 5/10 rolls 1d20 to 15 to beat else takes 1..20 damage"
"""